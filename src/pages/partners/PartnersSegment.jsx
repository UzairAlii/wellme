    ...
    id='forPartnersAndRestaurants'
       ...
       gap-8 bg-white/30 backdrop-blur-lg rounded-[32px] border border-white/40 shadow-xl px-6 py-10">
        ...
        <div className="flex-1 flex flex-col items-center md:items-start justify-center">
          ...
          <div className="flex flex-col gap-3 w-full mb-4">
            <div className="bg-[#e3eaf7] rounded-full py-2 px-4 text-xs tracking-wide font-semibold text-[#3c1d00] w-fit md:text-start text-center shadow-sm">
      ...
      <motion.div
       ...
       gap-8 bg-white/30 backdrop-blur-lg rounded-[32px] border border-white/40 shadow-xl px-6 py-10 mt-8">
        {/* Left Content */}
        <div className="flex-1 flex flex-col items-center md:items-start justify-center">
          <h2 className="mac text-lg md:text-2xl font-bold text-[#3c1d00] mb-3">SERVICE PROVIDERS</h2>
          <p className="text-base md:text-xl md:text-start text-center text-[#222] mb-6 w-[90%]">
            Offer your services to an industry workforce that’s been overlooked for too long. From telehealth to childcare, counselling to financial tools, your business gets direct access.
          </p>
          <div className="flex flex-col gap-3 w-full mb-4">
            <div className="bg-[#ecdbe2] rounded-full py-2 px-4 text-xs tracking-wide font-semibold text-[#3c1d00] w-fit md:text-start text-center shadow-sm">
              WE INTEGRATE YOUR SERVICE → WORKERS DISCOVER YOU <br className="hidden md:block" />→ YOU GAIN NEW CUSTOMERS + INSIGHTS.
            </div>
            <div className="bg-[#ecdbe2] rounded-full py-2 px-4 text-xs tracking-wide font-semibold text-[#3c1d00] w-fit md:text-start text-center shadow-sm">
