    ...
    <motion.div
           ...
           <div className='w-full flex flex-col items-center justify-center'>
             <motion.p
               ...
               className='text-center block lg:hidden text-md lg:text-lg w-full lg:w-[63%] openSauceRegular'>Become a Founding WellMe Partner and deliver your content or services directly to the people who need them most.</motion.p>
             <motion.p
                initial={{ y: 20, opacity: 0 }}
                whileInView={{ y: 0, opacity: 1 }}
                transition={{ delay: 1.2, duration: 0.8 }}
                className='text-center hidden lg:block text-md lg:text-lg w-full lg:w-[63%] openSauceRegular'>Become a Founding WellMe Partner and deliver your content or</motion.p>
             <motion.p
                initial={{ y: 20, opacity: 0 }}
                whileInView={{ y: 0, opacity: 1 }}
                transition={{ delay: 1.2, duration: 0.8 }}
                className='text-center hidden lg:block text-md lg:text-lg w-full lg:w-[63%] openSauceRegular'>services directly to the people who need them most.</motion.p>
